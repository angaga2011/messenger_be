...
const mockContacts = ["user1@example.com", "user2@example.com", "user3@example.com"];
const mockMessages = [
  { id: 1, content: "Hello!", sender: "user1@example.com", createdAt: new Date() },
  { id: 2, content: "How are you?", sender: "me", createdAt: new Date() },
];
